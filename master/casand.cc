/**
 * @file casand.cpp
 * @brief CASAN main program
 *
 * This file contains the `main` function of the CASAN master.
 * It reads the configuration file, then calls the master to
 * start the various threads (HTTP server, CASAN listener, etc.)
...
void usage (const char *prog)
{
    ...
    std::cerr << "\n" ;
    std::cerr << "Example: " << prog << " -d all-option -c ./casand.conf\n" ;
}
 ...
 * - start master: start threads for CASAN engine, HTTP servers, etc.
