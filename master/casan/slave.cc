/**
 * @file slave.cc
 * @brief CASAN slave class implementation
 */
 ...
 * Assoc Answer message (its /.well-known/casan).
 *
...
void slave::process_casan (casan *e, msgptr_t m)
{
	...
	case msg::CASAN_DISCOVER :
	    ...
	    break ;
	case msg::CASAN_ASSOC_REQUEST :
	    D (D_STATE, "Received ASSOC_REQUEST from another master") ;
	    break ;
	case msg::CASAN_ASSOC_ANSWER :
